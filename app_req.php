...
.responsive-table {
  ...
  @media all and (max-width: 767px) {
    ...
    <title>Appoinment Request</title>
    <!-- BOOTSTRAP STYLES-->
...
<body>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Appoinment Requests List</h2>
                    </div>
                </div>
...
?>
                                    <tr class="success">
                                        ...
                                        <td><a style="color:orange; text-decoration:none;" href="app_del.php?id=<?php echo $row['id'];?>">REJECT</a></td>
                                        <td><a style="color:green; text-decoration:none;" href="app_accept.php?id=<?php echo $row['id'];?>">ACCEPT</a></td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
                            </table>
