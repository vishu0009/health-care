...
session_start();
$pat=$_SESSION['pat'];
if($_SESSION['pat']==null){
    header("location:patient_login.php?Plaease login first");
}
?>
...
<html lang="en">
   ...
   <body class="clinic_version">
               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="pateint_logout.php" onclick="fun()">Logout</a></li>
                     </ul><script>
                        function fun(){
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='["Welcome <?php  echo $pat;  ?>", "Welcome to Health Care", "We Care Your Health", "We are Expert!" ]'>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time one" style="background:#2895f1;">
                     ...
                     <p>Bleeding, Heart Attack, Fever, Pain, Stroke, Burns & Sclades, Fractures</p>
                  </div>
               </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      ...
      <div id="service" class="services wow fadeIn">
         <div class="container">
            <div class="row">
                  ...
                  <div class="inner-services">
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <p>We Provide you best facilities and good environment.</p>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <p>We have a larger laboratory with suitable equipment.</p>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <p>We have best specialist that provide classic services.</p>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <p>We have also children care center.</p>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <p>Our infrastructure is veery fine and good.</p>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           ...
                           <p>We have a blood bank your extreme welcome.</p>
                        </div>
                     </div>
                  </div>
               </div>
               <?php
                 include "conn.php";
                 $sql="select `id`, `name`, `problem`, `email`, `gen`, `mob`, `age`, `adr` from `patient` where email='$pat'";
                        ...
                        <form method="post">
                           <fieldset>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="text" name="pro" value="<?php echo $row['problem'];  ?>"  />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="text" value="<?php echo $row['adr'];  ?>" name="adr" />
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <div class="center"><input style="background-color:#0f0" type="submit" name="save" value="Send" onclick="say()">
                                    <script>
                                      function say(){
      ...
      $age=$_POST['age'];
      $adr=$_POST['adr'];
       $sql1="insert `patient_req`( name, problem, email, mob, age, adr) values ('$name','$pro','$em','$mob','$age','$adr')";
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="footer-text">
                     <p>© 2018 Healthcare. All Rights Reserved.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="social">
